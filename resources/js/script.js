$(document).ready(function(){
    ...
    $('.js-btn-full').click(function(){
        $('html,body').animate({scrollTop: $('.js-plan-section').offset().top},1200);
    })

    $('.js-btn-ghost').click(function(){
        $('html,body').animate({scrollTop: $('.js--features-section').offset().top},1200);
    })



    //Smooth scrolling main nav
  ...
  $('.js-wp-2').waypoint(function(direction){
    $('.js-wp-2').addClass('animated fadeUpBig');
},{
    offset:'50%'
})
